...
export const resolveCacheLocation = async (name) => {
...
export const readPackageConfig = async (cwd) => {
...
export const isMonorepoRoot = (cwd) => {
    return existsSync(path.join(cwd, 'packages')) && existsSync(path.join(cwd, 'package.json'));
};
export const isMonorepo = async (cwd) => {
    const root = await findGitRoot() || cwd;
    return isMonorepoRoot(root);
};
export const resolveMonorepoPackageDirectories = async (cwd) => {
