...
export type LoaderType = 'babel' | 'style' | 'css' | 'cssModules' | 'postcss' | 'less' | 'img' | 'worker' | 'classNames' | 'cssExtract' | 'svgo' | 'svgToComponent';
...
export type WebpackFinalize = (webpackConfig: FinalizableWebpackConfiguration, buildEntry: WebpackBuildEntry, internals: BuildInternals) => FinalizableWebpackConfiguration | Promise<FinalizableWebpackConfiguration>;
export {};
